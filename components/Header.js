        ...
        <header>
            ...
            <div className='container mx-auto bg-gray-800 p-7 text-white rounded-xl'>
                <div className='flex flex-wrap content-center justify-between'>
                    ...
                    <button type='button' className='bg-white hover:bg-gray-800 px-4 py-2 text-gray-800 hover:text-white rounded-lg font-semibold'>Página Oficial Tailwind CSS</button>
                </div>
            </div>
        </header>
    )
